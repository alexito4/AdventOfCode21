...
//        print("reduced", self.debugDescription)
    ...
    func magnitude() -> Int {
        return left.magnitude(side: .left) + right.magnitude(side: .right)
    }
}
